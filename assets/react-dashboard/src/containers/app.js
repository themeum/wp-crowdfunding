				...
				<HashRouter>
						...
						<ul className='wpcf-dashboard-permalinks'>
							<li>
								<NavLink
									...
									to='/'
								>
									<Icon name='home' className='wpcf-icon' />
									{__('Dashboard', 'wp-crowdfunding')}
								</NavLink>
							</li>
							<li>
								<NavLink
									...
									to='/profile'
								>
									<Icon name='user' className='wpcf-icon' />
									{__('My Profile', 'wp-crowdfunding')}
								</NavLink>
							</li>
							<li
								className={
									this.state.myCampainsCollapse
										? 'wpcf-collapse'
										: 'wpcf-collapsed'
								}
							>
							...
							<li>
								<NavLink
									...
									to='/rewards'
								>
									<Icon name='gift' className='wpcf-icon' />
									{__('Rewards', 'wp-crowdfunding')}
								</NavLink>
							</li>
							<li
								className={
									this.state.userSettingsCollapse
										? 'wpcf-collapse'
										: 'wpcf-collapsed'
								}
							>
							...
							<li>
								<a onClick={this.logout}>
									<Icon name='logout' className='wpcf-icon' />
									{__('Logout', 'wp-crowdfunding')}
								</a>
							</li>
						</ul>
					</div>
					<div className='wpcf-dashboard-content'>
						...
						<Route
							...
							component={InvestedCampaigns}
						/>
						<Route
							path='/pledge-received'
							component={PledgeReceived}
						/>
						<Route
							path='/bookmark-campaigns'
							component={BookmarkCampaigns}
						/>
						...
						{WPCF.active_pro && (
							<Route
								...
								component={WithdrawMethodSettings}
							/>
						)}
					</div>
				</HashRouter>
