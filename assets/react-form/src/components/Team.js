...
class Team extends Component {
	...
	render() {
		...
		const {
			member: { id, name, email, image, manage, edit },
			emailInputMsg,
			editMember,
		} = this.state;
		return (
									...
									<form>
										<div className='wpcf-form-group'>
											...
											<div>
												...
												/>
												<p className='wpcf-field-info'>
													{emailInputMsg ||
														'Enter Collaborator email address'}
												</p>
											</div>
										</div>
											...
											<Fragment>
												...
												<div className='wpcf-form-group'>
													<p className='wpcf-field-desc'>
														{__(
															'If you Want to Show Contributor List',
															'wp-crowdfunding'
														)}
													</p>
													<label
														htmlFor='wpcf_manage_camp'
														className='wpcf-team-label'
													>
														<input
															id='wpcf_manage_camp'
															type='checkbox'
														...
														/>
														{__(
															'Give Permission to Manage Campaign',
															'wp-crowdfunding'
														)}
													</label>
												</div>
												...
												<div className='wpcf-form-group'>
													...
													>
														...
														/>
														{__(
															'Give Permission to Edit Campaign',
															'wp-crowdfunding'
														)}
													</label>
												</div>
