...
export const required = (value) =>
	value ? undefined : __('Please fill the required field', 'wp-crowdfunding');
export const isYoutubeUrl = (value) =>
	!value
		? undefined
		: value && getYotubeVideoID(value)
		? undefined
		: __('Invalid video url', 'wp-crowdfunding');
export const isEmail = (value) =>
	!value
		? undefined
		: value && validateEmail(value)
		? undefined
		: __('Invalid email address', 'wp-crowdfunding');
