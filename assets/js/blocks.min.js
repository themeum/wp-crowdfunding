...
/******/ 	return __webpack_require__(__webpack_require__.s = "./reactjs/src/index.js");
/******/ })
/************************************************************************/
/******/ ({
...
var Edit = function (_Component) {
    ...
    _createClass(Edit, [{
        ...
        value: function render() {
            ...
            var bgColors = [{ name: 'Color Code: var(--wpcf-primary-color)', color: 'var(--wpcf-primary-color)' }, { name: 'Color Code: #8224e3', color: '#8224e3' }, { name: 'Dark Black', color: '#111111' }, { name: 'Light Gray', color: '#767676' }, { name: 'White', color: '#ffffff' }];
...
var Edit = function (_Component) {
    ...
    _createClass(Edit, [{
        ...
        value: function render() {
            ...
            var mjColors = [{ name: 'Color Code: var(--wpcf-primary-color)', color: 'var(--wpcf-primary-color)' }, { name: 'Color Code: #8224e3', color: '#8224e3' }, { name: 'Dark Black', color: '#111111' }, { name: 'Light Gray', color: '#767676' }, { name: 'White', color: '#ffffff' }];

            // Title Color Color 
            var progressbarColors = [{ name: 'Color Code: var(--wpcf-primary-color)', color: 'var(--wpcf-primary-color)' }, { name: 'Color Code: #8224e3', color: '#8224e3' }, { name: 'Dark Black', color: '#111111' }];
