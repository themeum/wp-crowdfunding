jQuery( function( $ ) {
	...
	var wc_stripe_form = {
		...
		isStripeChosen: function() {
			return $( '#payment_method_wpneo_stripe_connect' ).is( ':checked' ) && ( ! $( 'input[name="wc-stripe-payment-token"]:checked' ).length || 'new' === $( 'input[name="wc-stripe-payment-token"]:checked' ).val() );
		},
