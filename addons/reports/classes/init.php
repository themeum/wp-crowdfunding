...
if ( ! class_exists('WPCF_Reports')) {
    class WPCF_Reports
    {
        ...
        public function wpcf_add_reports_page(){
            add_submenu_page('wpcf-crowdfunding', __('Reports', 'wp-crowdfunding'), __('Reports', 'wp-crowdfunding'), 'manage_options', 'wpcf-reports', array($this, 'WPCF_Reports'));
        }
        ...
        public function wpcf_add_report_assets($hook){
            ...
            wp_enqueue_script( 'field-date-js', plugins_url( '/assets/js/reports.js', __FILE__ ), array('jquery', 'jquery-ui-core', 'jquery-ui-datepicker'), time(),true );
