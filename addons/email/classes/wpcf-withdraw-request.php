...
class WPCF_Withdraw_Request extends WC_Email {
	...
	public function __construct() {
		...
		$this->description = __('Get email notification when a campaign owner request for withdraw', 'wp-crowdfunding');

		// these are the default heading and subject lines that can be overridden using the settings
		$this->heading = __('WP Crowdfunding withdraw Request is Processing', 'wp-crowdfunding');
		$this->subject = __('WP Crowdfunding withdraw Request is Processing', 'wp-crowdfunding');
		...
		add_action( 'wpneo_crowdfunding_withdrawal_request_email', array( $this, 'trigger' )); // Published Campaign Action
	...
	public function init_form_fields() {
		...
		$this->form_fields = array(
			...
			'subject'    => array(
				...
				'type'        => 'text',
				'description' => __('This controls the email subject line. Params: { [user_name], [request_title], [campaign_title], [withdrawal_amount], [withdraw_message] }', 'wp-crowdfunding'),
				'placeholder' => '',
				'default'     => __('A withdrawal request is received from your platform', 'wp-crowdfunding')
			),
			'subject_for_campaign_owner'    => array(
				'title'       => __('Subject For Campaign Owner', 'wp-crowdfunding'),
				'type'        => 'text',
				'description' => __('This controls the campaign owner notification email subject line. Params: { [user_name], [request_title], [campaign_title], [withdrawal_amount], [withdraw_message] }', 'wp-crowdfunding'),
				'placeholder' => '',
				'default'     => __('Congratulation, your withdrawal request has been submitted', 'wp-crowdfunding')
			),
			'heading'    => array(
			...
			'body'    => array(
				...
				'type'        => 'textarea',
				'description' => __('This controls the main email body contained within the email notification. Leave blank to keep it null | Params: { [user_name], [request_title], [campaign_title], [withdrawal_amount], [withdraw_message] }', 'wp-crowdfunding'),
				'placeholder' => '',
				'default'     => ''
			),
			...
			'body_for_campaign_owner'    => array(
				...
				'type'        => 'textarea',
				'description' => __('This controls the main email body contained within the campaign owner email notification. Leave blank to keep it null | Params: { [user_name], [request_title], [campaign_title], [withdrawal_amount], [withdraw_message] }', 'wp-crowdfunding'),
				'placeholder' => '',
				'default'     => ''
			),
