...
class WPCF_Target_Reached extends WC_Email {
	...
	public function __construct() {
		...
		$this->id = 'wpn_crowdfunding_target_reached_email';

		// this is the title in WooCommerce Email settings
		$this->title = 'WP CrowdFunding Target is Reached';

		// this is the description in WooCommerce email settings
		$this->description = __('Get email notification when a campaign target is reached', 'wp-crowdfunding');

		// these are the default heading and subject lines that can be overridden using the settings
		$this->heading = __('WP Crowdfunding Campaign Target is Reached', 'wp-crowdfunding');
		$this->subject = __('WP Crowdfunding Campaign Target is Reached', 'wp-crowdfunding');
	...
	public function trigger( $ID, $post ) {
        ...
        foreach ( $items as $item ) {
            ...
            $campaignRunning = WPNEOCF()->campaignValid( $campaign_id );
	...
	public function init_form_fields() {
		...
		$this->form_fields = array(
			...
			'subject'    => array(
				...
				'placeholder' => '',
				'default'     => __('Campaign [campaign_title] Target is Reached', 'wp-crowdfunding')
			),
