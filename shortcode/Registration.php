			...
			<div class="wpneo-user-registration-wrap">
				...
				<?php echo wp_kses_post( wp_nonce_field( 'wpcf_form_action', 'wpcf_form_action_field', true, false ) ); ?>
					...
					<div class="wpneo-single wpneo-register">
						<a href="<?php echo esc_url( get_home_url() ); ?>" class="wpneo-cancel-campaign"><?php esc_html_e( 'Cancel', 'wp-crowdfunding' ); ?></a>
						...
						<input type="submit" class="wpneo-submit-campaign" id="user-registration-btn" value="<?php esc_html_e( 'Sign UP', 'wp-crowdfunding' ); ?>" name="submits" />
					</div>
