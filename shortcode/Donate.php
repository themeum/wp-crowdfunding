...
add_shortcode('wp_crowdfunding_donate', array($this, 'wpcf_donate_callback_old')); //@comparability
add_shortcode('wpcf_donate', array($this, 'wpcf_donate_callback_new'));

function wpcf_donate_callback_old( $atts ){
    wpcf_donate_callback( $atts, 'wp_crowdfunding_donate' );
}

function wpcf_donate_callback_new( $atts ){
    wpcf_donate_callback( $atts, 'wpcf_donate' );
}
