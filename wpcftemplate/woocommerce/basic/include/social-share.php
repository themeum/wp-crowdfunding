        ...
        <?php if( !empty( $social ) ){ ?>
            ...
            <div class="social-container">
                ...
                <div class="links">
                    ...
                    <?php } ?>
                    <?php if( $embed ){ ?>
                        <a href="javascript:void(0)" class="embedlink" data-postid="<?php echo the_permalink( $post_id ); ?>"><i class="wpneo-icon wpneo-icon-embed" data-postid="<?php echo $post_id; ?>"></i></a>
                    <?php } ?>
                </div>
            </div>
