...
?>
			...
			<div class="social-container">
				...
				<div class="links">
					...
					<?php if ( in_array( 'tumblr', $social ) ) { ?>
						<a href="javascript:void(0)" class="wpcf-share s_tumblr"><i class="wpneo-icon wpneo-icon-tumblr"></i> </a>
					<?php } ?>
					<?php if ( in_array( 'blogger', $social ) ) { ?>
						<a href="javascript:void(0)" class="wpcf-share s_blogger"><i class="wpneo-icon wpneo-icon-blogger"></i> </a>
					<?php } ?>
					<?php if ( in_array( 'delicious', $social ) ) { ?>
						<a href="javascript:void(0)" class="wpcf-share s_delicious"><i class="wpneo-icon wpneo-icon-delicious"></i> </a>
					<?php } ?>
					<?php if ( in_array( 'digg', $social ) ) { ?>
						<a href="javascript:void(0)" class="wpcf-share s_digg"><i class="wpneo-icon wpneo-icon-digg"></i> </a>
					<?php } ?>
					<?php if ( in_array( 'reddit', $social ) ) { ?>
						<a href="javascript:void(0)" class="wpcf-share s_reddit"><i class="wpneo-icon wpneo-icon-reddit"></i> </a>
					<?php } ?>
					<?php if ( in_array( 'stumbleupon', $social ) ) { ?>
						<a href="javascript:void(0)" class="wpcf-share s_stumbleupon"><i class="wpneo-icon wpneo-icon-stumbleupon"></i> </a>
					<?php } ?>
					<?php if ( in_array( 'pocket', $social ) ) { ?>
						<a href="javascript:void(0)" class="wpcf-share s_pocket"><i class="wpneo-icon wpneo-icon-pocket"></i> </a>
					<?php } ?>
					<?php if ( in_array( 'WordPress', $social ) ) { ?>
						<a href="javascript:void(0)" class="wpcf-share s_wordpress"><i class="wpneo-icon wpneo-icon-wordpress"></i> </a>
					<?php } ?>
					...
					<?php } ?>
					<?php if ( $embed ) { ?>
						<a href="javascript:void(0)" class="embedlink" data-postid="<?php echo esc_attr( the_permalink( $post_id ) ); ?>"><i class="wpneo-icon wpneo-icon-embed" data-postid="<?php echo esc_attr( $post_id ); ?>"></i></a>
					<?php } ?>
				</div>
			</div>
			<script type="text/javascript">
				jQuery(document).ready(function($){
					$('.wpcf-share').ShareLink({
						...
						image: "<?php echo esc_url( $post_thumbnail_url ); ?>",
	...
	<?php if ( ! $enable_social && $embed ) { ?>
		<div class="social-container">
			<span><?php esc_html_e( 'Share: ', 'wp-crowdfunding' ); ?></span>
			<div class="links">
				<a href="javascript:;" class="embedlink" data-postid="<?php echo esc_attr( the_permalink( $post_id ) ); ?>"><i class="wpneo-icon wpneo-icon-embed" data-postid="<?php echo esc_attr( $post_id ); ?>"></i></a>
			</div>
		</div>
	<?php } ?>