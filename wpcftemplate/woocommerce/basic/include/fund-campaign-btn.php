	...
	if ($product->get_type() == 'crowdfunding') {
		if (wpcf_function()->is_campaign_valid()) {
            ...
            <form enctype="multipart/form-data" method="post" class="cart AA">
                ...
                <button type="submit" class="<?php echo apply_filters('add_to_donate_button_class', 'cf-button-primary cf-donate-button'); ?>"><?php _e('Back Campaign', 'wp-crowdfunding'); ?></button>
            </form>
