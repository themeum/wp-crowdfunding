...
<div class="wpneo-campaign-creator-info-wrapper">
    ...
    <div class="wpneo-campaign-creator-details">
        ...
        <p><?php echo wpcf_function()->author_campaigns($post->post_author)->post_count; ?> <?php esc_html_e("Campaigns","wp-crowdfunding"); ?> | <?php echo wpcf_function()->loved_count(); ?> <?php esc_html_e("Loved campaigns","wp-crowdfunding"); ?> </p>
        ...
        <?php } ?>
        <p><a href="javascript:;" data-author="<?php echo $post->post_author; ?>" class="wpneo-fund-modal-btn wpneo-link-style1"><strong><?php esc_html_e('See full bio', 'wp-crowdfunding'); ?></strong></a></p>
    </div>
</div>