...
if ( ! class_exists( 'Initial_Setup' ) ) {
	...
	class Initial_Setup {
			...
			<div class="notice notice-error wpcf-install-notice">
				<div class="wpcf-install-notice-inner">
					<div class="wpcf-install-notice-icon">
						<img src="<?php echo esc_url( WPCF_DIR_URL . 'assets/images/woocommerce-icon.png' ); ?>" alt="logo" />
					</div>
					<div class="wpcf-install-notice-content">
						...
						printf(
							...
							esc_html__( 'You must have', 'wp-crowdfunding' ),
							'https://wordpress.org/plugins/woocommerce/',
							esc_html__( 'WooCommerce', 'wp-crowdfunding' ),
							esc_html__( 'installed and activated on this website in order to use WP Crowdfunding.', 'wp-crowdfunding' )
						);
						?>
					...
					<div class="wpcf-install-notice-button">
						<a class="button button-primary" href="<?php echo esc_url( add_query_arg( array( 'action' => 'activate_woocommerce_free' ), admin_url() ) ); ?>"><?php esc_html_e( 'Activate WooCommerce', 'wp-crowdfunding' ); ?></a>
					</div>
				</div>
			</div>
			<?php
		...
		public function free_plugin_not_installed() {
			...
			<div class="notice notice-error wpcf-install-notice">
				<div class="wpcf-install-notice-inner">
					...
					<div class="wpcf-install-notice-button">
						<a class="install-wpcf-button button button-primary" data-slug="woocommerce" href="<?php echo esc_url( add_query_arg( array( 'action' => 'install_woocommerce_free' ), admin_url() ) ); ?>"><?php esc_html_e( 'Install WooCommerce', 'wp-crowdfunding' ); ?></a>
					</div>
				</div>
		...
		public function install_woocommerce_plugin() {
			...
			$title = sprintf( esc_html__( 'Installing Plugin: %s' ), $api->name . ' ' . $api->version );
