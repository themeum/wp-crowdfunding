    ...
    public function dashboard_block_callback( $att ){
        ...
        if( isset($_GET['page_type']) ){ $get_id = $_GET['page_type']; }
            ...
            $html .= '<style>';
                ...
                $html .= '.wpneo-links div.active a, .wpneo-links div a:hover, .wpcf-dashboard .wpcf-form-label > p, .wpcf-dashboard .wpcrowd-listing-content .wpcrowd-admin-title h3 a{
                    color: '. $majorColor .';
                }';
