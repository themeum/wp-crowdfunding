...
class Submit_Form{
    ...
    public function submit_form_block_callback( $att ){
        ...
        $html .= '<style>';
            $html .= 'input[type="button"].wpneo-image-upload, .wpneo-image-upload.float-right, .wpneo-image-upload-btn, #addreward, #wpneofrontenddata .wpneo-form-action input[type="submit"].wpneo-submit-campaign, .cf-form-group .wpneo-image-upload-btn {
