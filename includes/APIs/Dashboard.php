...
class API_Dashboard {
    ...
    function register_rest_api() {
        ...
        register_rest_route( $namespace, '/wc-countries', array(
            array( 'methods' => $method_readable, 'callback' => array($this, 'wc_countries'),'permission_callback' => '__return_true' ),
        ));
        register_rest_route( $namespace, '/logout', array(
            array( 'methods' => $method_readable, 'callback' => array($this, 'logout'),'permission_callback' => '__return_true' ),
        ));
    }
        ...
        if ( $wp_query->have_posts() ) {
            ...
            while ( $wp_query->have_posts() ) {
                ...
                $data[]         = array(
                    ...
                    'raised_percent'    => (float) wpcf_function()->get_raised_percent(),
                    'total_raised'      => $total_raised,
