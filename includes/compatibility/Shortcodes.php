...
add_shortcode( 'wp_crowdfunding_dashboard',             array( $wpcf_dashboard, 'dashboard_callback' ) );
add_shortcode( 'wp_crowdfunding_listing',               array( $wpcf_project_listing, 'listing_callback' ) );
add_shortcode( 'wp_crowdfunding_form',                  array( $wpcf_campaign_submit_from, 'campaign_form_callback' ) );
add_shortcode( 'wp_crowdfunding_search_shortcode',      array( $wpcf_search_box, 'search_callback' ) );
add_shortcode( 'wp_crowdfunding_registration',          array( $wpcf_registraion, 'registration_callback' ) );
