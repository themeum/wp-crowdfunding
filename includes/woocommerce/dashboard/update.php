    ...
    $html .= '<div class="wpneo-shadow wpneo-padding25 wpneo-clearfix">';
        ...
        $html .= '<div style="display: '.$display.'" id="wpcf-campaign-update-field">';
            $html .= '<div class="wpcf-campaign-update wpcf-card">';
                ...
                $html .= '</p>';
                $html .= '<p class="form-field wpneo_prject_update_title_field[]_field wpcf-form-group wpneo-second-half">';
                ...
                $html .= '</p>';
                $html .= '<p class="form-field wpneo_prject_update_details_field[]_field wpcf-form-group">';
