        ...
        <div class="wpneo-listings-dashboard wpneo-shadow wpneo-padding15 wpneo-clearfix">
            ...
            <div class="wpneo-listing-img">
                ...
                <div class="overlay">
                    <div>
                        <div>
                            <a class="wp-crowd-btn wp-crowd-btn-primary" href="<?php echo get_permalink(); ?>"><?php esc_html_e('View','wp-crowdfunding'); ?></a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="wpneo-admin-title float-left">
                    ...
                    <?php if($location) { ?>
                        <div class="wpneo-location">
                            ...
                            <div class="wpneo-meta-desc"><?php echo esc_html($location); ?></div>
                        </div>
                    <?php } ?>
                </div>
                <div class="wpneo-admin-location float-right">
                    ...
                    $operation_btn .= '<div class="wpneo-fields-action">';
                        ...
                        if ($page_id != '') {
                            ...
                            $operation_btn .= '<span><a href="'.$permalink_update.'">'.esc_html__("Update", "wp-crowdfunding").'</a></span>';
                            $operation_btn .= '<span><a href="' . $permalink_edit . '" class="wp-crowd-btn wp-crowd-btn-primary">' . esc_html__("Edit", "wp-crowdfunding") . '</a></span>';
                        }
                        
                    if (get_post_status() == 'draft'){
	                    $operation_btn .='<span class="wp-crowd-btn wpneo-campaign-status">['.esc_html__("Draft", "wp-crowdfunding").']</span>';
                    }
                    $operation_btn .= '</div>';
                    echo $operation_btn;
                    ?>
