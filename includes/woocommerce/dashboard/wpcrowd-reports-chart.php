...
<div class="wpneo-dashboard-chart wpneo-shadow chart-container">
	<div class="wpneo-dashboard-head wpneo-clearfix">
		<div class="wpneo-dashboard-head-left">
			...
			<ul>
				<li class="<?php echo ( $date_range === 'last_7_days' ) ? 'active' : ''; ?>"><a href="<?php echo esc_url( add_query_arg( array( 'date_range' => 'last_7_days' ), get_permalink() ) ); ?>"><?php echo esc_html__( '1W', 'wp-crowdfunding' ); ?></a></li>
				<li class="<?php echo ( $date_range === 'last_14_days' ) ? 'active' : ''; ?>"><a href="<?php echo esc_url( add_query_arg( array( 'date_range' => 'last_14_days' ), get_permalink() ) ); ?>"><?php echo esc_html__( '2W', 'wp-crowdfunding' ); ?></a></li>
				<li class="<?php echo ( $date_range === 'this_month' ) ? 'active' : ''; ?>"><a href="<?php echo esc_url( add_query_arg( array( 'date_range' => 'this_month' ), get_permalink() ) ); ?>"><?php echo esc_html__( '1M', 'wp-crowdfunding' ); ?></a></li>
				<li class="<?php echo ( $date_range === 'last_3_months' ) ? 'active' : ''; ?>"><a href="<?php echo esc_url( add_query_arg( array( 'date_range' => 'last_3_months' ), get_permalink() ) ); ?>"><?php echo esc_html__( '3M', 'wp-crowdfunding' ); ?></a></li>
				<li class="<?php echo ( $date_range === 'last_6_months' ) ? 'active' : ''; ?>"><a href="<?php echo esc_url( add_query_arg( array( 'date_range' => 'last_6_months' ), get_permalink() ) ); ?>"><?php echo esc_html__( '6M', 'wp-crowdfunding' ); ?></a></li>
				<li class="<?php echo ( $date_range === 'this_year' ) ? 'active' : ''; ?>"><a href="<?php echo esc_url( add_query_arg( array( 'date_range' => 'this_year' ), get_permalink() ) ); ?>"><?php echo esc_html__( '1Y', 'wp-crowdfunding' ); ?></a></li>
			</ul>
		...
		<div class="dashboard-head-right">
			<form method="get" action="" class="dashboard-head-date">
				...
				<input type="text" id="datepicker" name="date_range_from" class="datepickers_1" value="<?php echo esc_html( date( 'Y-m-d', strtotime( $from_date ) ) ); ?>" placeholder="From" />
				<span><?php esc_html_e( 'to', 'wp-crowdfunding' ); ?></span>
				<input type="text" name="date_range_to" class="datepickers_1" value="<?php echo esc_html( date( 'Y-m-d', strtotime( $given_to_date ) ) ); ?>" placeholder="To" />
	...
	<div class="wpneo-dashboard-summary wpneo-clearfix">
		<ul>
			<li class="active"><span class="wpneo-value"> <?php echo wp_kses_post( wc_price( array_sum( $total_backers_amount_ever ) ) ); ?></span><span class="wpneo-value-info"><?php esc_html_e( 'Fund Raised', 'wp-crowdfunding' ); ?></span></li>
			<li><span class="wpneo-value"><?php echo esc_html( array_sum( $sales_count_ever ) ); ?></span><span class="wpneo-value-info"><?php esc_html_e( 'Total Backed', 'wp-crowdfunding' ); ?></span></li>
		...
		var lineChart = new Chart(ctx, {
			...
			data: {
				...
				datasets: [{
					...
					pointRadius: 5,
					pointHoverRadius: 8,
					pointHoverBackgroundColor:'var(--wpcf-primary-color)',
					pointHoverBorderColor:'#fff',
					backgroundColor:'var(--wpcf-primary-color)',
					borderColor:'#DCDCE9',
					borderWidth: 3,
					pointStyle: 'circle',
				}]
