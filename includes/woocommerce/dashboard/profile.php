...
<form id="wpcf-dashboard-form">
    <div class="wpcf-row">
        <div class="wpcf-col-lg-6">
            <div class="wpcf-card">
                ...
                <div class="wpcf-form-fields">
                    ...
                    <button id="cc-image-upload-file-button" class="wpcf-button-primary wpneo-image-upload" style="display: none;">'.__( "Upload" , "wp-crowdfunding" ).'</button>
                </div>
            </div>
            ...
            <div class="wpcf-card">
                ...
                <label class="wpcf-form-label"><?php _e( "Name:" , "wp-crowdfunding" ); ?></label>
                <div class="wpcf-form-fields"><?php echo wpcf_function()->get_author_name($current_user_id); ?></div>
                ...
                <div class="wpcf-form-group">
                    <label class="wpcf-form-label"><?php _e( "About Us" , "wp-crowdfunding" ); ?></label>
                    <div class="wpcf-form-fields">
                ...
                <div class="wpcf-form-group">
                    <label class="wpcf-form-label"><?php _e( "Bio" , "wp-crowdfunding" ); ?></label>
                    <div class="wpcf-form-fields">
        ...
        <div class="wpcf-col-lg-6">
            <div class="wpcf-card">
                ...
                <div class="wpcf-form-group">
                    <label class="wpcf-form-label"><?php _e( "Mobile Number" , "wp-crowdfunding" ); ?></label>
                    <div class="wpcf-form-fields">
                ...
                <div class="wpcf-form-group">
                    <label class="wpcf-form-label"><?php _e( "Fax" , "wp-crowdfunding" ); ?></label>
                    <div class="wpcf-form-fields">
                ...
                <div class="wpcf-form-group">
                    <label class="wpcf-form-label"><?php _e( "Website" , "wp-crowdfunding" ); ?></label>
                    <div class="wpcf-form-fields">
                ...
                <div class="wpcf-form-group">
                    <label class="wpcf-form-label"><?php _e( "Address" , "wp-crowdfunding" ); ?></label>
                    <div class="wpcf-form-fields">
            ...
            <div class="wpcf-card">
                ...
                <div class="wpcf-form-group">
                    <label class="wpcf-form-label"><?php _e( "Facebook" , "wp-crowdfunding" ); ?></label>
                    <div class="wpcf-form-fields">
                ...
                <div class="wpcf-form-group">
                    <label class="wpcf-form-label"><?php _e( "Twitter" , "wp-crowdfunding" ); ?></label>
                    <div class="wpcf-form-fields">
                ...
                <div class="wpcf-form-group">
                    <label class="wpcf-form-label"><?php _e( "Linkedin" , "wp-crowdfunding" ); ?></label>
                    <div class="wpcf-form-fields">
                ...
                <div class="wpcf-form-group">
                    <label class="wpcf-form-label"><?php _e( "Pinterest" , "wp-crowdfunding" ); ?></label>
                    <div class="wpcf-form-fields">
                ...
                <div class="wpcf-form-group">
                    <label class="wpcf-form-label"><?php _e( "VK" , "wp-crowdfunding" ); ?></label>
                    <div class="wpcf-form-fields">
    ...
    <?php if ($logged_user_info) : ?>
        ...
        <button id="wpneo-edit" class="wpcf-button-secondary wpneo-edit-btn"><?php _e( "Edit", "wp-crowdfunding" ); ?></button>
        <button id="wpneo-dashboard-btn-cancel" class="wpcf-button-primary wpneo-cancel-btn wpneo-hidden" type="submit"><?php _e( "Cancel", "wp-crowdfunding" ); ?></button>
        <button id="wpneo-profile-save" class="wpcf-button-primary wpneo-save-btn wpneo-hidden" type="submit"><?php _e( "Save", "wp-crowdfunding" ); ?></button>
        </div>
    <?php endif; ?>
