...
if (! class_exists('WPCF_Frontend_Hook')) {
    ...
    class WPCF_Frontend_Hook {
        ...
        public function __construct() {
            ...
            add_filter( 'woocommerce_is_sold_individually',     array($this, 'wc_remove_crowdfunding_quantity_fields'), 10, 2 ); //Remove quantity and force item 1 cart per checkout if product is crowdfunding
        ...
        public function wc_remove_crowdfunding_quantity_fields( $return, $product ) {
            if ($product->get_type() == 'crowdfunding'){
                return true;
            }
            return $return;
