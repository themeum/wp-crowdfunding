...
if (! class_exists('WPNEO_WC_Reward')) {
    ...
    class WPNEO_WC_Reward{
        ...
        public function __construct(){
            ...
            add_action('woocommerce_review_order_after_cart_contents', array($this, 'wpneo_selected_reward_in_order_review'));
        ...
        */
	    ...
	    public function wpneo_selected_reward_in_order_review(){
